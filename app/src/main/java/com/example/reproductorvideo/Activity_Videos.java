...
import com.example.reproductorvideo.AdapterVideoList;
import com.example.reproductorvideo.ModelVideo;
...
public class Activity_Videos extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(this, 1)); //numero de columnas de la galeria
